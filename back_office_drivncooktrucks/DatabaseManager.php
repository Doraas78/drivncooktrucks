...
class DatabaseManager{
    ...
    public function __construct(){
        ...
        try{
            ...
            $this->db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION); // throw exception, great for debugging
    ...
    public function query(string $statement, string $className = null, bool $oneResult = false) {
        ...
        // write SQL statement into log_query_sql
        $sql = $statement;
        /*$str = $sql . " [". date("Y-m-d H:i:s") ."]" . PHP_EOL;
        file_put_contents("log_query_sql.txt", $str,FILE_APPEND);*/
